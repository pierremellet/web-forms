...
public class FormField {
  ...
  public FormField(String id, String type, Boolean required, ComplexRule display, I18NString description, I18NString label, Object config) {
    this.id = id;
    this.type = type;
  ...
  public ComplexRule getDisplay() {
    return display;
  }

  public void setDisplay(ComplexRule display) {
    this.display = display;
  }
